...
const trackNames = {
    ...
    B: "JAVA MODERNIZATION WITH BOB",
    C: "BOB ON A REAL-WORLD APPLICATION",
    D: "SECURE DEVELOPMENT WITH IBM BOB",
    E: "ENHANCING MAXIMO WITH BOB"
};
...
downloadBtn.addEventListener("click", () => {
    ...
    link.download =
        `IBM-BOB-Developer-Day-Calgary-2026-${safeName}-Track-${trackCode}.png`;
